...
def chatting(request, pk, name):
    ...
    try:
        ...
        # If chatroom does not exist, create it and set first_time_connection to True
        chatroom = ChatRoom.objects.create(name=roomName)
        first_time_connection = True

    # If this is the first time connection, create an initial chat entry with combineroom=True
    ...
    context['first_time_connection'] = first_time_connection

    print(context['first_time_connection'])
